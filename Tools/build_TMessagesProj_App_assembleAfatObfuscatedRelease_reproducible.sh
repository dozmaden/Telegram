...
# Build and verify the reproducible obfuscated main app APK.
#
# This script intentionally builds only:
#   :TMessagesProj_App:assembleAfatObfuscatedRelease
#
# The Gradle flavor already defines the native ABIs. Do not pass an ABI property
# here; this build currently produces the configured 64-bit APK.
#
# Flow:
...
BUILD_ID="TMessagesProj_App_assembleAfatObfuscatedRelease_reproducible"
VARIANT_DIR="afatObfuscatedRelease"
TASK=":TMessagesProj_App:assembleAfatObfuscatedRelease"
MODULE_DIR="$ROOT_DIR/TMessagesProj_App"
APK_PATH="$MODULE_DIR/build/outputs/apk/afatObfuscated/release/app.apk"
MAPPING_DIR="$MODULE_DIR/build/outputs/mapping/$VARIANT_DIR"
