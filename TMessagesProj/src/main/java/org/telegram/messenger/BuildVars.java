...
public class BuildVars {
    ...
    public static String SAFETYNET_KEY = BuildConfig.SAFETYNET_KEY;
    public static String PLAYSTORE_APP_URL = BuildConfig.PLAYSTORE_APP_URL;
    public static String HUAWEI_STORE_URL = BuildConfig.HUAWEI_STORE_URL;
    ...
    public static boolean IS_BILLING_UNAVAILABLE = BuildConfig.IS_BILLING_UNAVAILABLE;

    // works only on official app ids, disable on your forks
    public static boolean SUPPORTS_PASSKEYS = BuildConfig.SUPPORTS_PASSKEYS;

    public static boolean USE_LEGACY_SYSTEM_INSETS = BuildConfig.USE_LEGACY_SYSTEM_INSETS;
